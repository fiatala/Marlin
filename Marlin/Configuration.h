...
#define STRING_CONFIG_H_AUTHOR "local" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
  ...
  // local board is v4.2.2 GD, which uses A4988 driver for the GD32F303RET6 chip
...
#define CUSTOM_MACHINE_NAME "Ender3Pro-4.2.2-GD-CRTouch"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -7, -1.3 }
